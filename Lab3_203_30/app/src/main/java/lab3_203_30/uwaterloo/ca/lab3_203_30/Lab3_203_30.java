...
public class Lab3_203_30 extends AppCompatActivity {
    ...
    final int GAMEBOARD_DIMENSION = 1200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab3_203_30);
        ...
        myGameLoopTask = new GameLoopTask(Lab3_203_30.this, layout, context);


        //instantiating a timer with a period of 30ms
        myGameLoop = new Timer();
        myGameLoop.schedule(myGameLoopTask, 30, 30);
